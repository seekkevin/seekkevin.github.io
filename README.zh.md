...
### [我的博客在这里 &rarr;](http://www.geeken.info)
...
```
# Site settings
title: k Blog             # 你的博客网站标题
SEOTitle: k Blog			# 在后面会详细谈到
description: "Cool Blog"    # 随便说点，描述一下

# SNS settings      
github_username: seekkevin     # 你的github账号
weibo_username: seekkevin      # 你的微博账号，底部链接会自动更新的。
...
---
layout:     keynote
iframe:     "http://xx.me/js-module-7day/"
---
```
...
我的博客标题是 **"0x1a | hack"** 但是我想要在搜索的时候显示 **“0x1a | hack”** ，这个就需要SEO Title来定义了。
